...
class SimpleTree:
    ...
    def EvenTreesRecursive(self, node: SimpleTreeNode, nodes_for_remove: list) -> int:
        """
        calc count nodes for delete recursive
        :param node: SimpleTreeNode
        ...
        if count % 2 == 0 and node.Parent:
            nodes_for_remove.append(node.Parent)
    ...
    def EvenTrees(self) -> list:
        ...
        nodes_for_remove = []
        self.EvenTreesRecursive(self.Root, nodes_for_remove)
        return nodes_for_remove
